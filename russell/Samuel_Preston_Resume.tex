...
\name{Preston}{Samuel}
\position{Web Developer{\enskip\cdotp\enskip}Security Expert}
\address{Birmingham, UK}

\mobile{+44 794942 0516}
\email{samp.reston@outlook.com}
%\dateofbirth{January 1st, 1970}
\homepage{www.sampreston.co.uk}
\github{github.com/samp-reston}
\linkedin{linkedin.com/in/samp-reston}
% \gitlab{gitlab-id}
